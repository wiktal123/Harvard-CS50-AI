...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence1, sentence2 in itertools.combinations(self.knowledge,2):
            infSentence = sentence1.inference(sentence2)
            if infSentence is not None and infSentence not in self.knowledge:
                newSentences.append(infSentence)
